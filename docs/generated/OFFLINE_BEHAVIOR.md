...
- **Offline queue (enqueue → sync later)** — `artifacts/mobile/src/features/profile/components/AccountActions.tsx`
...
- **Offline queue (enqueue → sync later)** — `artifacts/mobile/src/shared/services/index.ts`
