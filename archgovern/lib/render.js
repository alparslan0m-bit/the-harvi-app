...
> **Note to AI Agents**: This file is auto-generated by the governance engine (\`${ENGINE_NAME}\`). Nodes, edges, and layers are derived directly from the codebase, and curated prose is linted against known-stale terms — the build fails on any drift. Use this to understand the structure, layers, and flows of the application.
